...
from flysuite import FruitFly
from flysuite.tasks.arenas.ball import BallFloor
from flysuite.tasks.arenas.hills import SineBumps, SineTrench
from flysuite.tasks.flight_imitation import FlightImitationWBPG
from flysuite.tasks.pattern_generators import WingBeatPatternGenerator
from flysuite.tasks.template_task import TemplateTask
from flysuite.tasks.trajectory_loaders import (
    HDF5FlightTrajectoryLoader,
    HDF5WalkingTrajectoryLoader,
    InferenceWalkingTrajectoryLoader,
)
from flysuite.tasks.vision_flight import VisionFlightImitationWBPG
from flysuite.tasks.walk_imitation import WalkImitation
from flysuite.tasks.walk_on_ball import WalkOnBall


def flight_imitation(ref_path: str,
