...
from flysuite.tasks.synthetic_trajectories import constant_speed_trajectory
from flysuite.tasks.constants import _FLY_CONTROL_TIMESTEP, _WALK_CONTROL_TIMESTEP
